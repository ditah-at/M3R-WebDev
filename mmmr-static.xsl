...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="zim-acdh">Zentrum für Informationsmodellierung – Austrian Centre for Digital
...
-->
            ...
            <script type="text/javascript" src="{$jquery_js}"><xsl:text> </xsl:text></script>
            ...
            <script type="text/javascript" src="{$sticky_kit_js}"><xsl:text> </xsl:text></script>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    ...
                                    <a
                                        href="http://glossa.uni-graz.at/context:mmmr"
                                        >All Manuscripts</a>
                                </li>
                                ...
                                <li>
                                    ...
                                    <a
                                        href="http://glossa.uni-graz.at/o:mmmr.k4984"
                                        >K 4984</a>
                                </li>
                                ...
                                <li>
                                    ...
                                    <a
                                        href="http://glossa.uni-graz.at/o:k4984.1r"
                                        >Folio 1r</a>
                                </li>
                                <li role="seperator" class="divider"/>
                                <li>
                                    ...
                                    <a
                                        href="http://glossa.uni-graz.at/o:mmmr.hs1"
                                        >Traditionskodex HS1</a>
                                </li>
                                ...
                                <li>
                                    ...
                                    <a
                                        href="http://glossa.uni-graz.at/o:mmmr.hs1.50r"
                                        >Folio 50r</a>
                                </li>
                        ...
                        <li class="dropdown">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" role="button"
                                aria-haspopup="true" aria-expanded="false">SKOS <span class="caret"><xsl:text> </xsl:text></span></a>
                            <ul class="dropdown-menu">
                                <li>
                                    ...
                                    <a
                                        href="http://glossa.uni-graz.at/o:mmmr.damage"
                                        >Damage</a>
                                </li>
